...
const _errorMap = /* @__PURE__ */ new WeakMap();
...
export {
  Euler as $,
  CylinderGeometry as A,
  Box3 as B,
  Color as C,
  DoubleSide as D,
  PlaneGeometry as E,
  Float32BufferAttribute as F,
  Group as G,
  Spherical as H,
  InstancedInterleavedBuffer as I,
  MOUSE as J,
  Controls as K,
  Line3 as L,
  Matrix4 as M,
  LineBasicMaterial as N,
  Object3D as O,
  Plane as P,
  Quaternion as Q,
  Ray as R,
  ...
  UniformsUtils as U,
  Vector3 as V,
  WireframeGeometry as W,
  BoxGeometry as X,
  OctahedronGeometry as Y,
  TorusGeometry as Z,
  SphereGeometry as _,
  Uint8BufferAttribute as a,
  HalfFloatType as a$,
  WebGLRenderTarget as a0,
  RGBAFormat as a1,
  UnsignedByteType as a2,
  BackSide as a3,
  Scene as a4,
  DirectionalLight as a5,
  AmbientLight as a6,
  CameraHelper as a7,
  PlaneHelper as a8,
  AxesHelper as a9,
  LinearMipmapNearestFilter as aA,
  NearestMipmapNearestFilter as aB,
  LinearFilter as aC,
  NearestFilter as aD,
  RepeatWrapping as aE,
  MirroredRepeatWrapping as aF,
  ClampToEdgeWrapping as aG,
  Material as aH,
  PropertyBinding as aI,
  SkinnedMesh as aJ,
  LineLoop as aK,
  Skeleton as aL,
  AnimationClip as aM,
  Bone as aN,
  InterpolateDiscrete as aO,
  InterpolateLinear as aP,
  Texture as aQ,
  VectorKeyframeTrack as aR,
  NumberKeyframeTrack as aS,
  QuaternionKeyframeTrack as aT,
  ColorManagement as aU,
  Interpolant as aV,
  TriangleStripDrawMode as aW,
  TriangleFanDrawMode as aX,
  Sprite as aY,
  GridHelper as aZ,
  ACESFilmicToneMapping as a_,
  LineSegments as aa,
  Loader as ab,
  MeshStandardMaterial as ac,
  FileLoader as ad,
  NoBlending as ae,
  GLSL3 as af,
  TOUCH as ag,
  TorusKnotGeometry as ah,
  ShapeUtils as ai,
  Shape as aj,
  ShapeGeometry as ak,
  REVISION as al,
  Fog as am,
  IcosahedronGeometry as an,
  NeutralToneMapping as ao,
  EquirectangularReflectionMapping as ap,
  LoaderUtils as aq,
  MeshPhysicalMaterial as ar,
  LinearSRGBColorSpace as as,
  SpotLight as at,
  PointLight as au,
  TextureLoader as av,
  ImageBitmapLoader as aw,
  InterleavedBuffer as ax,
  LinearMipmapLinearFilter as ay,
  NearestMipmapLinearFilter as az,
  Vector2 as b,
  VSMShadowMap as b$,
  DataTexture as b0,
  UVMapping as b1,
  LinearMipMapLinearFilter as b2,
  DataUtils as b3,
  RenderTarget as b4,
  BufferGeometryLoader as b5,
  TrianglesDrawMode as b6,
  HemisphereLight as b7,
  ConeGeometry as b8,
  TimestampQuery as b9,
  OneMinusConstantAlphaFactor as bA,
  ConstantAlphaFactor as bB,
  OneMinusConstantColorFactor as bC,
  ConstantColorFactor as bD,
  OneMinusDstAlphaFactor as bE,
  OneMinusDstColorFactor as bF,
  OneMinusSrcAlphaFactor as bG,
  OneMinusSrcColorFactor as bH,
  DstAlphaFactor as bI,
  DstColorFactor as bJ,
  SrcAlphaSaturateFactor as bK,
  SrcAlphaFactor as bL,
  SrcColorFactor as bM,
  OneFactor as bN,
  ZeroFactor as bO,
  NotEqualCompare as bP,
  GreaterCompare as bQ,
  GreaterEqualCompare as bR,
  EqualCompare as bS,
  LessEqualCompare as bT,
  LessCompare as bU,
  AlwaysCompare as bV,
  NeverCompare as bW,
  MeshDepthMaterial as bX,
  MeshDistanceMaterial as bY,
  PCFShadowMap as bZ,
  PCFSoftShadowMap as b_,
  warnOnce as ba,
  EventDispatcher as bb,
  NoToneMapping as bc,
  setConsoleFunction as bd,
  createCanvasElement as be,
  error as bf,
  warn as bg,
  log as bh,
  WebGLCoordinateSystem as bi,
  probeAsync as bj,
  RawShaderMaterial as bk,
  SRGBTransfer as bl,
  ArrayCamera as bm,
  WebXRController as bn,
  DepthStencilFormat as bo,
  DepthFormat as bp,
  UnsignedInt248Type as bq,
  UnsignedIntType as br,
  DepthTexture as bs,
  RAD2DEG as bt,
  RGFormat as bu,
  NoColorSpace as bv,
  LessEqualDepth as bw,
  ReverseSubtractEquation as bx,
  SubtractEquation as by,
  AddEquation as bz,
  MathUtils as c,
  CullFaceFront as c$,
  FloatType as c0,
  WebGLCubeRenderTarget as c1,
  CubeDepthTexture as c2,
  RGBAIntegerFormat as c3,
  RGIntegerFormat as c4,
  RedIntegerFormat as c5,
  UnsignedShortType as c6,
  UnsignedShort4444Type as c7,
  UnsignedShort5551Type as c8,
  ExternalTexture as c9,
  RGBA_ASTC_6x5_Format as cA,
  RGBA_ASTC_6x6_Format as cB,
  RGBA_ASTC_8x5_Format as cC,
  RGBA_ASTC_8x6_Format as cD,
  RGBA_ASTC_8x8_Format as cE,
  RGBA_ASTC_10x5_Format as cF,
  RGBA_ASTC_10x6_Format as cG,
  RGBA_ASTC_10x8_Format as cH,
  RGBA_ASTC_10x10_Format as cI,
  RGBA_ASTC_12x10_Format as cJ,
  RGBA_ASTC_12x12_Format as cK,
  RGBA_BPTC_Format as cL,
  RGB_BPTC_SIGNED_Format as cM,
  RGB_BPTC_UNSIGNED_Format as cN,
  RED_RGTC1_Format as cO,
  SIGNED_RED_RGTC1_Format as cP,
  RED_GREEN_RGTC2_Format as cQ,
  SIGNED_RED_GREEN_RGTC2_Format as cR,
  NotEqualDepth as cS,
  GreaterDepth as cT,
  GreaterEqualDepth as cU,
  EqualDepth as cV,
  LessDepth as cW,
  AlwaysDepth as cX,
  NeverDepth as cY,
  CullFaceNone as cZ,
  CullFaceBack as c_,
  UnsignedInt5999Type as ca,
  UnsignedInt101111Type as cb,
  ByteType as cc,
  ShortType as cd,
  IntType as ce,
  AlphaFormat as cf,
  RGBFormat as cg,
  RedFormat as ch,
  RGB_S3TC_DXT1_Format as ci,
  RGBA_S3TC_DXT1_Format as cj,
  RGBA_S3TC_DXT3_Format as ck,
  RGBA_S3TC_DXT5_Format as cl,
  RGB_PVRTC_4BPPV1_Format as cm,
  RGB_PVRTC_2BPPV1_Format as cn,
  RGBA_PVRTC_4BPPV1_Format as co,
  RGBA_PVRTC_2BPPV1_Format as cp,
  RGB_ETC1_Format as cq,
  RGB_ETC2_Format as cr,
  RGBA_ETC2_EAC_Format as cs,
  R11_EAC_Format as ct,
  SIGNED_R11_EAC_Format as cu,
  RG11_EAC_Format as cv,
  SIGNED_RG11_EAC_Format as cw,
  RGBA_ASTC_4x4_Format as cx,
  RGBA_ASTC_5x4_Format as cy,
  RGBA_ASTC_5x5_Format as cz,
  SRGBColorSpace as d,
  DecrementWrapStencilOp as d$,
  NormalBlending as d0,
  CustomBlending as d1,
  MultiplyBlending as d2,
  SubtractiveBlending as d3,
  AdditiveBlending as d4,
  EquirectangularRefractionMapping as d5,
  DataArrayTexture as d6,
  mergeUniforms as d7,
  CubeUVReflectionMapping as d8,
  TangentSpaceNormalMap as d9,
  WebGPUCoordinateSystem as dA,
  BasicShadowMap as dB,
  DynamicDrawUsage as dC,
  FrustumArray as dD,
  RectAreaLight as dE,
  LightProbe as dF,
  FramebufferTexture as dG,
  NormalRGPacking as dH,
  Matrix2 as dI,
  NoNormalPacking as dJ,
  NormalGAPacking as dK,
  Camera as dL,
  isTypedArray as dM,
  MeshPhongMaterial as dN,
  MeshToonMaterial as dO,
  MeshNormalMaterial as dP,
  MeshMatcapMaterial as dQ,
  SpriteMaterial as dR,
  ShadowMaterial as dS,
  NotEqualStencilFunc as dT,
  GreaterStencilFunc as dU,
  GreaterEqualStencilFunc as dV,
  EqualStencilFunc as dW,
  LessEqualStencilFunc as dX,
  LessStencilFunc as dY,
  AlwaysStencilFunc as dZ,
  NeverStencilFunc as d_,
  ObjectSpaceNormalMap as da,
  getUnlitUniformColorSpace as db,
  cloneUniforms as dc,
  CustomToneMapping as dd,
  AgXToneMapping as de,
  CineonToneMapping as df,
  ReinhardToneMapping as dg,
  LinearToneMapping as dh,
  getByteLength as di,
  LinearTransfer as dj,
  CubeReflectionMapping as dk,
  CubeRefractionMapping as dl,
  Uint32BufferAttribute as dm,
  Uint16BufferAttribute as dn,
  arrayNeedsUint32 as dp,
  Layers as dq,
  CubeTexture as dr,
  Data3DTexture as ds,
  createElementNS as dt,
  AddOperation as du,
  MixOperation as dv,
  MultiplyOperation as dw,
  MinEquation as dx,
  MaxEquation as dy,
  StaticDrawUsage as dz,
  InterleavedBufferAttribute as e,
  IncrementWrapStencilOp as e0,
  DecrementStencilOp as e1,
  IncrementStencilOp as e2,
  InvertStencilOp as e3,
  ReplaceStencilOp as e4,
  ZeroStencilOp as e5,
  KeepStencilOp as e6,
  Float16BufferAttribute as e7,
  RGBIntegerFormat as e8,
  CubeCamera as e9,
  ...
  LineDashedMaterial as o,
  Line as p,
  MeshLambertMaterial as q,
  FrontSide as r,
  Mesh as s,
  ShaderMaterial as t,
  InstancedBufferGeometry as u,
  Vector4 as v,
  Clock as w,
  MeshBasicMaterial as x,
  Matrix3 as y,
  InstancedMesh as z
};
//# sourceMappingURL=three.core-CntQ0PPt.js.map
